...
register_all_protocols(register_cb cb, gpointer client_data)
{
    ...
    {extern void proto_register_ieee802154e (void); if(cb) (*cb)(RA_REGISTER, "proto_register_ieee802154e", client_data); proto_register_ieee802154e ();}
...
register_all_protocol_handoffs(register_cb cb, gpointer client_data)
{
    ...
    {extern void proto_reg_handoff_ieee802154e (void); if(cb) (*cb)(RA_HANDOFF, "proto_reg_handoff_ieee802154e", client_data); proto_reg_handoff_ieee802154e ();}
